...
var _customizeMap = require("./customizeMap");
var _location = require("./location");
var _course = require("./course");
var _api = require("./api");
var _distanceCalculator = require("./distanceCalculator");
const currentLocation = new (0, _location.CurrentLocation)();
const distanceCalculator = new (0, _distanceCalculator.DistanceCalculator)();
const courseSessionManager = new (0, _api.CourseSessionManager)();
const golfCourse = new (0, _course.Course)();
let customMap;
async function initializeCourseData() {
    try {
        ...
        if (courseData && courseData.holes) golfCourse.setAllHoles(courseData.holes);
        else throw new Error("No holes data available for the selected course");
    } catch (error) {
...
async function initMap() {
    ...
    if (mapDiv) try {
        ...
        if (location) customMap = new (0, _customizeMap.CustomizedMap)(mapDiv, {
            lat: location.lat,
            lng: location.long
        });
        else {
            console.error("Location is null or undefined.");
            customMap = new (0, _customizeMap.CustomizedMap)(mapDiv, {
                lat: 60,
                lng: -135
            });
        }
    } catch (Error1) {
        console.error("Error getting current location:", Error1);
        customMap = new (0, _customizeMap.CustomizedMap)(mapDiv, {
            lat: 60,
            lng: -135
        });
    }
    else console.error("Map div element not found.");
}
    ...
    if (addHoleButton && holePopup && holeForm) {
        ...
        holeForm.addEventListener("submit", async (event)=>{
            ...
            if (hole) try {
                ...
                } else alert("Current location is not available.");
            } catch (error) {
                alert("Error calculating distance: " + error);
            }
            else alert("Invalid hole number.");
        });
    }
});
window.initMap = initMap;

},{"./customizeMap":"eYN9F","./location":"6PjY6","./course":"khiRx","./api":"1w4TK","./distanceCalculator":"kVMbV"}],"eYN9F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CustomizedMap", ()=>CustomizedMap);
var _location = require("./location");
class CustomizedMap {
    constructor(mapDiv, location){
        this._currentLocation = new (0, _location.CurrentLocation)();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./location":"6PjY6"}],"gkKU3":[function(require,module,exports) {
...
},{}],"6PjY6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"khiRx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Course {
    ...
    getHole(index) {
        if (index < 1 || index > 18) throw new Error("Invalid hole number. Must be between 1 and 18.");
    ...
    setAllHoles(holes) {
        if (holes.length !== 18) throw new Error("A golf course must have exactly 18 holes.");
        this.holes = holes;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1w4TK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CourseSessionManager", ()=>CourseSessionManager);
    ...
    async fetchCourseData() {
        try {
            ...
            if (response.ok) {
                ...
                return courseData;
            } else throw new Error("Could not retrieve holes data for the selected course");
        } catch (error) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kVMbV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DistanceCalculator", ()=>DistanceCalculator);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fm8Gy","h7u1C"], "h7u1C", "parcelRequire36c5")
